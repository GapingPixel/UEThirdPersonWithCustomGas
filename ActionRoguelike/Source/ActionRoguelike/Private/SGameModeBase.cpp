...
void ASGameModeBase::OnMonsterLoaded(FPrimaryAssetId LoadedId, FVector SpawnLocation)
{
	...
	if (Manager)
	{
		...
		if (MonsterData)
		{
			TObjectPtr<AActor> NewBot = GetWorld()->SpawnActor<AActor>(MonsterData->MonsterClass, SpawnLocation, FRotator::ZeroRotator);
			if (NewBot)
			{
...
{
	UE_LOG(LogTemp, Log, TEXT("OnActorKilled: Victim %s, Killed: %s"), *GetNameSafe(VictimActor), *GetNameSafe(Killer));
...
void ASGameModeBase::WriteSaveGame()
{
	...
	{
		AActor* Actor = *It;
		if (!Actor->Implements<USGameplayInterface>())//Looks for our gameplay Actors
		{
			continue;
		}
		...
		//Find Only values with UPROPERTY
